...
const MbtiWidget = ({ data, user }: MbtiDataProps) => {
    ...
    return (
        <Card elevation={0}>
            <Box height={'9.5rem'} display={'flex'} justifyContent={'space-between'} padding={'1.5rem'}>
                <Box alignSelf={'stretch'} display={'flex'} flexDirection={'column'} justifyContent={'space-between'}>
