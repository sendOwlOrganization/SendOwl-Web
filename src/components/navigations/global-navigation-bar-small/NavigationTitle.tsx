...
const TITLES: Record<string, ReactNode> = {
    [BALANCE_GAMES_URL]: <SideMenuLink href={BALANCE_GAMES_URL}
                                       icon={<BalanceGameIcon color={MLAB_ICON_COLORS.balanceGame} />}
                                       title={'밸런스 게임'} />,
    [COMMUNITY_URL]: <SideMenuLink href={COMMUNITY_URL}
                                   icon={<CommunityIcon color={MLAB_ICON_COLORS.community} />}
                                   title={'커뮤니티'} />,
    [INSIGHTS_URL]: <SideMenuLink href={INSIGHTS_URL}
                                  icon={<InsightIcon color={MLAB_ICON_COLORS.insight} />}
                                  title={'인사이트'} />,
    [NOTICES_URL]: <SideMenuLink href={NOTICES_URL}
                                 icon={<NoticeIcon color={MLAB_ICON_COLORS.notice} />}
                                 title={'공지/이벤트'} />,
    [SERVICE_CENTER_URL]: <SideMenuLink href={SERVICE_CENTER_URL}
                                        icon={<ServiceCenterIcon color={MLAB_ICON_COLORS.serviceCenter}
                                                                 colorKey={700} />}
                                        title={'고객센터'} />,
};
