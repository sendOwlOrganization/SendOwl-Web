...
const BodyArea = styled(Stack)<{ padding: string }>(
    ({ theme, padding }) => css`
        padding: ${padding};
    `
);
    ...
    return (
        <Container>
            ...
            <BodyArea padding={search ? '20px' : '32px'} spacing={5}>
                {search ? (
                    <SearchAutocomplete words={recentlySearched} inputRef={inputRef} query={search} />
                ) : (
                    <>
            ...
            <FootArea>
                <Typography variant={'subtitle4'} fontWeight={'normal'} marginRight={'0.75rem'}>
                    검색어 기록
                </Typography>
